FROM myrotvorets/node:latest@sha256:0d4449fb3555d551900fa62f776a59b4d7020175544187ae4aa4a8082512d4b2 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min:latest@sha256:b25d1282f32cb01f349cdd69f1025ebc320b0648cca601262f3a41a77fdd15ff
USER root
