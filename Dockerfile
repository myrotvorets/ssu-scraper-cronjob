FROM myrotvorets/node:latest@sha256:f0a52ad915ece07cdb4b73f96b9e87019d2c1714ed6e1260cfcae71c2e47cfab AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min:latest@sha256:8e246102a616d508911e6412157ee2b1f992cd71006631f65fd5cdb143ae898b
USER root
