FROM myrotvorets/node:latest@sha256:bc81a64fb7ef91a747bb227b2886054dfc1344970a5b0340712f0da70caba020 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min:latest@sha256:39cd3b198c0cb8472e06e0043a4f83efd6e2a9e3fe6ff504954910a05453e0cc
USER root
