FROM myrotvorets/node:latest@sha256:aaac19e64d2b87e6794d76123fd092cc93976ff4cbd98149e3faff6616d6d562 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min:latest@sha256:1da0d198cacf742eda78a086d54c1962922dfca83a0038208575a1b2bdcbcb39
USER root
