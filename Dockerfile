FROM myrotvorets/node:latest@sha256:46a581875a2ea51e0bfb4493a7d2f37da26b4b15e24eac372d6b89cba63ac942 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min:latest@sha256:356ebee64e01fb3a6747ece816382c3890d600cbd626002eec2c571194801604
USER root
