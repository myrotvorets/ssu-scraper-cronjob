FROM myrotvorets/node:latest@sha256:95a8b70e7a249709af8107bd431fc063919f25d3487c215f12b9d0b8934108df AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min:latest@sha256:16ebade1463b307abc275c51209ace8b85da17a5787d85fb08ba88bc487d74b3
USER root
